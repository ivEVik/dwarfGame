...
namespace dwarfGame
{
	...
	{
		public static Attack ATTACK_UNARMED { get { return new Attack(new Dice(CONST.DIE_D3), 1, 0); } }
		public static Attack ATTACK_UNARMED_IMPROVED { get { return new Attack(new Dice(CONST.DIE_D2), 1, FLAG.ATTACK_ROLL_ATTRIBUTE); } }
		public static Attack ATTACK_UNARMED_ZOMBIE { get { return new Attack(new Dice(CONST.DIE_D3, 2), 1, 0); } }
		public static Attack ATTACK_UNARMED_SLIME { get { return new Attack(new Dice(CONST.DIE_D3, 2), 1, 0); } }
		
		public static MobTemplate MOB_NULL
		{
			get { return new MobTemplate(
				MobID: CONST.MOB_NULL
				);
			}
		}
		
		public static MobTemplate MOB_DWARF_BRAWLER
		{
			get { return new MobTemplate(
		...
		public static MobTemplate MOB_ZOMBIE_SHAMBLER
		{
			get { return new MobTemplate(
		...
		public static MobTemplate MOB_SLIME {
			get { return new MobTemplate(
		...
		public static TileTemplate TILE_BRICK {
			get { return new TileTemplate(
		...
		public static MapTemplate MAP_TEST {
			get { return new MapTemplate(
				Name: "Test Map",
...
.....",
		...
		public static MapTemplate MAP_TEST_BIG {
			get { return new MapTemplate(
				Name: "Test Map",
				TileDict: MakeTileset(
					Tuple.Create(' ', TILE_NULL),
